...
<html>
    ...
    <body>
        ...
        <div id="show-resourceRating" class="content scaffold-show" role="main">
            ...
            <f:display bean="resourceRating" />
            <g:form resource="${this.resourceRating}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.resourceRating}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
