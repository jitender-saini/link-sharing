<div class="form-group editTopic" style="padding-bottom:25px" data-id="editTopic${topic.id}">
    ...
    <div class="col-xs-2">
        <button type="button" class="btn btn-success buttonSave" data-id="${topic.id}"
                id="topicSaveButton${topic.id}" data-url="${g.createLink(controller: 'topic',action: 'updateTopicName')}">Save</button>
    </div>
